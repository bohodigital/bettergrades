...
try {
  ...
  // The source binding records the committed input snapshot. Generated artifacts
  // may also include reviewed worktree changes; make that distinction explicit
  // instead of implying that sourceCommit describes every generated byte.
  graph.provenance = {
    inputBaseCommit: sourceCommit,
    inputBaseTree: sourceTree,
    artifactState: "includes-current-worktree",
    authoritativeCandidate: "the commit containing this generated artifact",
  };
