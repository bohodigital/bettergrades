...
const expectations = { "unit-2a": { count: 27, interactive: 1, jsxgraph: 0 }, "unit-2b": { count: 34, interactive: 7, jsxgraph: 1 }, "unit-3a": { count: 11, interactive: 4, jsxgraph: 0 }, "unit-3b": { count: 9, interactive: 4, jsxgraph: 0 }, "unit-4a": { count: 18, interactive: 7, jsxgraph: 0 }, "unit-4b": { count: 20, interactive: 6, jsxgraph: 0 } };
