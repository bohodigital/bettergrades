...
export const resources: ResourceRecord[] = [...allLibraryArticles.map((article) => ({
  ...
  title: "When to use integration by parts: recognition and setup",
  ...
  searchTerms: ["when to use integration by parts", "integration by parts recognition", "choose u and dv"],
