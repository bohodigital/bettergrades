...
const chapterDefinitions = [
  ...
  { id: "meaning", from: 4, to: 10, title: "Section 1: What a limit means", description: "Build the neighborhood idea with motion, tables, holes, one-sided behavior, and graphs.", lens: "What are nearby outputs doing as the input approaches the target from both sides?" },
  { id: "finite", from: 11, to: 18, title: "Section 2: Finite limits and algebra", description: "Turn indeterminate forms into solvable expressions using substitution, limit laws, factoring, conjugates, and piecewise reasoning.", lens: "What did direct substitution reveal, and which algebraic move removes the obstacle without changing nearby behavior?" },
  { id: "trigonometric", from: 19, to: 25, title: "Section 3: Trigonometric limits", description: "Use squeezing, the fundamental sine limit, identities, and scaling to make trigonometric behavior predictable.", lens: "Can the expression be rewritten around a known small-angle limit, with every scaling factor accounted for?" },
  { id: "infinite", from: 26, to: 32, title: "Section 4: Infinite behavior", description: "Read vertical, horizontal, and slant asymptotes through sign analysis and dominant-term reasoning.", lens: "Is the function growing without bound near a finite input, or settling into end behavior as the input grows?" },
  { id: "continuity", from: 33, to: 41, title: "Section 5: Continuity", description: "Connect limits to function values, classify discontinuities, repair piecewise definitions, and use the Intermediate Value Theorem.", lens: "Do the limit, the function value, and the surrounding domain fit together at the point or across the interval?" },
  { id: "formal", from: 42, to: 46, title: "Section 6: Formal limits", description: "Translate the intuitive neighborhood picture into epsilon-delta language, constructive proofs, graph windows, and counterexamples.", lens: "How small must the input window be to force every allowed output into the requested tolerance band?" },
  { id: "synthesis", from: 47, to: 47, title: "Section 7: Synthesis", description: "Bring the unit together by choosing methods, explaining decisions, and correcting weak spots before an exam.", lens: "Can you diagnose the limit type and justify a method before beginning the algebra?" },
];
