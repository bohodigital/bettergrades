...
import unit4bPublic from "../../content/calculus/units/unit-4b/assessments.public.json" with { type: "json" };
import unit4bServer from "../../content/calculus/units/unit-4b/assessments.server.json" with { type: "json" };
import unit4bSetPublic from "../../content/calculus/units/unit-4b/assessment-sets.public.json" with { type: "json" };
import unit4bSetServer from "../../content/calculus/units/unit-4b/assessment-sets.server.json" with { type: "json" };
...
const unitPayloads = new Map([
  ...
  [unit4bPublic.unit_id, { public: unit4bPublic, server: unit4bServer, setPublic: unit4bSetPublic, setServer: unit4bSetServer }],
]);
