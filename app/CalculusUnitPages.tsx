...
const integrationApplicationDeepDives = [
  ["/subjects/math/calculus/integration-applications/average-value-of-a-function/", "Average value of a function"],
  ["/subjects/math/calculus/integration-applications/washer-vs-shell/", "Washer method or shell method?"],
  ["/subjects/math/calculus/integration-applications/work-and-fluid-force/", "Work and fluid force"],
...
const unitMapProfiles = {
  ...
  "calc-2-unit-4a-sequences-infinite-series": {
    pathIntro: "Begin with sequences as integer-indexed functions, define series through partial sums, then choose and justify convergence tests before estimating tails.",
    teachesTitle: "Turn infinite processes into precise convergence decisions.",
    teaches: "Interpret and analyze sequences; build series from partial sums; sum geometric and telescoping series; select comparison, integral, ratio, root, and alternating-series tests; distinguish absolute from conditional convergence; and control approximation error.",
    prerequisitesTitle: "Unit 3B completion, algebra, limits, derivatives, and integrals.",
