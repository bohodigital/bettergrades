...
function ToolsPage() { return <Shell><section className="page-hero section-pad"><Eyebrow>Tools</Eyebrow><h1>Useful tools. Visible limits.</h1><p>Compute less blindly. Every tool should explain its recommendation and tell you when to be skeptical.</p></section><section className="single-product section-pad"><Link href="/tools/math/calculus/integration-method-finder/" className="product-row"><span className="product-mark">ƒ?</span><div><Eyebrow>Mathematics · Calculus · Working tool</Eyebrow><h2>Integration Method Finder</h2><p>Identify the structure of an integral, then get a ranked method and a short decision path.</p><span className="tag">Method recognition</span><span className="tag">No universal-solver claims</span></div><b>Open tool ↗</b></Link><p className="honest-note"><strong>Why only one tool?</strong> Because a working tool is more useful than a showroom of “coming soon” buttons. New subject tools join this directory when their explanations and limitations are reliable.</p></section></Shell>; }
