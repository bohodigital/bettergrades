        ...
        <nav className="desktop-nav" aria-label="Primary">
          <details className="desktop-learn-menu">
            ...
            <div className="desktop-learn-panel desktop-path-panel"><section>
                ...
                <a href="/subjects/math/precalculus/" onClick={navigationClick("/subjects/math/precalculus/", "desktop-primary")}><b>Precalculus</b><small>Functions, models, and change</small></a>
        ...
        <div className="header-actions">
          ...
          <details className="mobile-menu"><summary aria-label="Open menu">Menu</summary><nav aria-label="Mobile navigation">
            ...
            <details className="mobile-course-menu"><summary>Learn</summary><div>
              ...
              <a className="mobile-navigation-link" href="/subjects/math/precalculus/" onClick={navigationClick("/subjects/math/precalculus/", "mobile-menu")}><b>Precalculus</b><small>Functions, models, and change</small></a>
  ...
  return (
    <Shell>
      <section className="page-hero compact search-hero section-pad">
        ...
        <div className="search-filter-block"><span>Course</span><div className="search-filters" aria-label="Filter by course">{[["all", "All math"], ["algebra", "Algebra"], ["precalculus", "Precalculus"], ["calculus", "Calculus"]].map(([value, label]) => <button key={value} type="button" className={domain === value ? "active" : ""} onClick={() => setDomain(value)}>{label}</button>)}</div></div>
      ...
      <section className="search-results section-pad">
        ...
        {(siteResults.length > 0 || showExpressionTool) && <><h3 className="group-label">Keep browsing by course</h3><div className="next-moves"><Link href="/subjects/math/algebra/"><b>Algebra</b><span>Build from expressions through functions →</span></Link><Link href="/subjects/math/precalculus/"><b>Precalculus</b><span>Connect functions, models, and representations →</span></Link><Link href="/subjects/math/calculus/"><b>Calculus</b><span>Follow the connected calculus course →</span></Link></div></>}
...
function NoResults({ query }: { query: string }) { return <div className="no-results"><span className="big-symbol">∅</span><h3>No useful match yet.</h3><p>Try the skill instead of the whole assignment, such as “factor trinomials,” “function notation,” or “integration by parts.”</p>{query && <code>{query}</code>}<div className="button-row"><Link href="/subjects/math/algebra/" className="button button-ink">Browse algebra</Link><Link href="/subjects/math/precalculus/" className="button button-ghost">Browse precalculus</Link><Link href="/subjects/math/calculus/" className="button button-ghost">Browse calculus</Link></div></div>; }
