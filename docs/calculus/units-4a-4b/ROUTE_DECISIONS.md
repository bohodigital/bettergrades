...
| `/subjects/math/calculus/sequences-series/power-series-interval-of-convergence/` | Retain until Unit 4B review | Unit 4B is not yet public; final collision decision follows the Unit 4A postmortem. |
| `/subjects/math/calculus/sequences-series/taylor-series-remainder/` | Retain until Unit 4B review | Unit 4B is not yet public; final collision decision follows the Unit 4A postmortem. |
