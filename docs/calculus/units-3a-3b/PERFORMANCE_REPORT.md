...
The corrected Unit 3A map HTML measured 48,382 bytes on all four origins. The corrective release added no dependency or client visual payload and retained the same 11 content-addressed Unit 3A visual assets.
