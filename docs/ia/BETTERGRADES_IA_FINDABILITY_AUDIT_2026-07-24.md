...
**Machine-observed:** 509 canonical HTML routes resolve into 328 textbook lessons, 6 worksheets, 26 worked problems, and the other roles in the inventory. The rendered graph has 32130 deduplicated typed internal-link edges. 215 routes have no contextual incoming link, and 15 important routes are beyond four navigation edges or unreachable in the navigation-only graph.
...
- Repository start: `bd8c106e74f203f68e2f27595523610c4a911c39`
- Source tree: `badf00de3bad5d9c348275d8d09b8fdb24a82c92`
- Local Pages build hash: `f0ae10fe9330b29d0667f8a59f1f09f5a05a9e7ddf10d43a69343d3b0d5c2840`
...
- Audit worktree: `/Users/darksmarskin/Documents/local2/worktrees/bettergrades-ia-findability-audit-20260724`
...
- assessment-reference: 373
- breadcrumb: 1894
- contextual-body: 6729
- course-map: 69
- footer: 8800
- global-navigation: 7730
- glossary-reference: 16
- hub-listing: 713
- mobile-navigation: 3464
- primary-action: 81
- related-content: 951
- resource-companion: 700
- sequential-next: 67
...
- Navigation-deep or unreachable routes: 64
- Important navigation-deep or unreachable routes: 15
- All-link unreachable routes: 5
- Navigation-only incoming pages: 213
- Browser scenario rows: 60; failures: 0
- Direct-navigation rows: 21; search-assisted rows: 39
- Search-assisted rows ranking the exact destination below first: 21

## 7. Internal-link graph results

- Deduplicated rendered edges: 32130
- Contextual incoming zero: 215
- Contextual candidate edges currently present: 8825
- Sequential gaps: 320

## 8. Site-search results

- Search records: 677
- Queries executed: 2390
- Exact-title queries not ranking exact page first: 5
...
328 textbook lessons were assessed. The candidate file contains 2522 rows; practice and reference gaps are separated for editorial review.

## 11. Search-intent and cannibalization risks

78 provisional concept clusters contain 26 same-role conflict rows. These are screening results, not automatic merge/noindex decisions.

## 12. Page-template and chrome findings

Static framing metrics cover 509 routes; browser geometry covers 509. 0 routes exceed the bounded framing threshold.
...
Desktop/mobile target parity has 7 mismatches. Mobile screenshots and scenario evidence are under `artifacts/ia/screenshots/`.
...
- **IA-001 P1_HIGH:** 5 exact-title queries did not rank the exact page first.
- **IA-002 P1_HIGH:** 215 routes have zero contextual incoming links.
- **IA-003 P1_HIGH:** 15 important routes are unreachable or more than four navigation edges from home.
- **IA-004 P1_HIGH:** 26 inferred concept/role clusters contain multiple pages with the same role.
