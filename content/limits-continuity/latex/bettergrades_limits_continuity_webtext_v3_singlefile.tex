...
\titleformat{\chapter}[display]
  ...
  {\filleft\fontsize{13}{15}\selectfont CALCULUS I \;\textcolor{BGGold}{/}\; CHAPTER \thechapter}
  {0.4ex}
...
\begin{description}
  \item[Pass 1: Learn.] Use the chapter and check answers after small groups of problems.
...
\section*{Chapter 1 Concept Quiz}
\addcontentsline{toc}{section}{Chapter 1 Concept Quiz}
...
\section*{Chapter 4 Concept Quiz}
\addcontentsline{toc}{section}{Chapter 4 Concept Quiz}
...
\section{Chapter Exercise Answers}
...
\begin{enumerate}[label=\textbf{2.\arabic*}]
  ...
  \item Substitute, identify the form, then choose structure-specific algebra as summarized in the chapter decision tree.
\end{enumerate}
...
\begin{enumerate}[label=\textbf{6.\arabic*}]
  ...
  \item \(\delta=\eps/3\).
  \item \(\delta=2\eps\).
  \item Use the proof in the chapter.
...
\begin{enumerate}[label=\textbf{R\arabic*.}]
  ...
  \item See Chapter 3 theorem statement.
  \item \(\lim_{x\to0}\sin x/x=1\), in radians.
  \item See Chapter 5 theorem statement.
